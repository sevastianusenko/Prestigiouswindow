  ...
  return (
    <section className="mx-auto max-w-7xl px-5 sm:px-8 pt-14 sm:pt-20 pb-24 grid lg:grid-cols-2 gap-12 items-start">
      <div>
        ...
        <p className="mt-6 text-lg text-graphite/75 max-w-md">
        ...
        <div className="mt-10 space-y-5 font-mono text-sm">
          <div className="flex gap-4 border-t border-mist pt-4">
          ...
          <div className="flex gap-4 border-t border-mist pt-4 border-b pb-4">
